...
/**
 * Class WPBakeryShortCode_Konte_Banner
 */
class WPBakeryShortCode_Konte_Banner extends WPBakeryShortCode {
	/**
	...
	public function getStyles( $el_class, $css, $google_fonts_data, $font_container_data, $atts ) {
		...
		$css_class = array(
			'konte-banner',
			'color-scheme-' . ( $atts['scheme'] ? $atts['scheme'] : 'default' ),
		...
		/**
		 * Filter 'VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG' to change konte_banner class
		 *
