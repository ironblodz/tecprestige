<?php
/**
 * Konte WooCommerce Adjacent Products Class
 *
 * @since 2.3.8
 */
...
if ( ! class_exists( 'Konte_WooCommerce_Adjacent_Products' ) ) :

	/**
	 * The Konte WooCommerce Adjacent Products Class
	 */
	class Konte_WooCommerce_Adjacent_Products {
		...
		private function query_wc() {
			...
			$products = wc_get_products( apply_filters( 'konte_woocommerce_adjacent_query_args', $args ) );
